...
//import styles from './NsSuiteletConnectorWebPart.module.scss';
import * as strings from 'NsSuiteletConnectorWebPartStrings';

export interface INsSuiteletConnectorWebPartProps {
  description: string;
}
